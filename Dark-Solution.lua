...
StatsPicture.Name = ".gg/RzmwsGtUuF"
...
StatsHealthBackground.Name = ".gg/RzmwsGtUuF"
...
StatsHealthBar.Name = ".gg/RzmwsGtUuF"
...
local Actyrn = UiLib:CreateWindow("Dark Solution | .gg/RzmwsGtUuF ", Vector2.new(500, 600), Enum.KeyCode.RightShift)
...
local TrashTalkTog = UtilitiesSec:AddToggle("Trash Talk", false, function(Value)
	if Value then
		local TrashTalkWords = {".gg/RzmwsGtUuF", ".gg/RzmwsGtUuF", ".gg/RzmwsGtUuF", ".gg/RzmwsGtUuF", ".gg/RzmwsGtUuF", ".gg/RzmwsGtUuF", ".gg/RzmwsGtUuF", ".gg/RzmwsGtUuF", ".gg/RzmwsGtUuF", ".gg/RzmwsGtUuF", ".gg/RzmwsGtUuF", ".gg/RzmwsGtUuF", ".gg/RzmwsGtUuF", ".gg/RzmwsGtUuF", ".gg/RzmwsGtUuF", ".gg/RzmwsGtUuF", ".gg/RzmwsGtUuF", ".gg/RzmwsGtUuF", ".gg/RzmwsGtUuF", ".gg/RzmwsGtUuF", ".gg/RzmwsGtUuF", ".gg/RzmwsGtUuF"}
		...
		if TargBindEnabled then
			...
			if TargetAimbot.Notify then
				StarterGui:SetCore("SendNotification", {
					Title = "Dark Solution [.gg/RzmwsGtUuF]", 
